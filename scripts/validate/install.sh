...
curl -O https://raw.githubusercontent.com/Deutsche-Digitale-Bibliothek/ddb-metadata-schematron-validation/main/mets-mods-ap-digitalisierte-zeitungen/ddb_validierung_mets-mods-ap-digitalisierte-zeitungen.xsl
